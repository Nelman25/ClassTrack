  ...
  return (  
    <div>
      ...
      {loading ? (
        ...
        <div className="max-w-[1440px] font-montserrat mx-auto grid grid-cols-[repeat(auto-fit,minmax(350px,1fr))] gap-10 mt-6">
          {classes.map((Class) => {
            return (
              <div
                onClick={() => handleSelectClass(Class.id)}
                key={Class.id}
                className="rounded-xl h-[350px] border border-slate-700 flex flex-col justify-center items-center text-center odd:text-slate-200 odd:bg-[#2E2EA1] even:bg-yellow-500"
              >
