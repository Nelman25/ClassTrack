      ...
      {loading ? (
        ...
        students.map((student) => {
          return (
            ...
            >
              <li className="py-2 min-w-[100px] truncate">{student.name}</li>

              <li className="py-2 min-w-[100px] truncate text-blue-600">
                {student.email}
              </li>
              <li className="py-2 min-w-[100px] truncate">
                {student.studentNumber}
              </li>
              <li className="py-2 min-w-[100px] truncate">{student.course}</li>
              <li className="py-2 min-w-[100px] truncate">{student.address}</li>
            </ul>
          );
        })
      )}
